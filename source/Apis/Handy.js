...
(function (factory) {
    ...
    exports.Handy = void 0;
    var Article_1 = require("./Article");
    var Handy = (function (_super) {
        __extends(Handy, _super);
        function Handy() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        Handy.prototype.create = function () {
            var args = [];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    this.app.post('/projektArtikelHandy', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    if (!projektArtikelData.artikel.handy) return [3, 4];
                                    return [4, this.createHandy(projektArtikelData, createdArtikel.artikel_id)];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
        ...
        Handy.prototype.createHandy = function (projektArtikelData, artikelId) {
            var _a, _b, _c, _d;
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0: return [4, this.prisma.handy.create({
                                data: {
                                    imei_1: projektArtikelData.artikel.handy.imei_1,
                                    besitzer: projektArtikelData.artikel.handy.besitzer,
                                    sim_karten_nummer: (_a = projektArtikelData.artikel.handy.sim_karten_nummer) !== null && _a !== void 0 ? _a : "",
                                    bildschirmsperre_pin: (_b = projektArtikelData.artikel.handy.bildschirmsperre_pin) !== null && _b !== void 0 ? _b : "",
                                    email_adresse: (_c = projektArtikelData.artikel.handy.email_adresse) !== null && _c !== void 0 ? _c : "",
                                    password: (_d = projektArtikelData.artikel.handy.password) !== null && _d !== void 0 ? _d : "",
                                    artikel: {
                                        connect: {
        ...
        Handy.prototype.read = function () {
            var _this = this;
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            this.app.get('/projektArtikelHandy/:projekt_id/:unterkategoriename', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        Handy.prototype.update = function () {
            var _this = this;
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            this.app.put('/projektArtikelHandy', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var projektArtikelData, existingHandy, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.allow_communikation_from_all_ip_adress(res);
                        ...
                        case 1:
                            _a.trys.push([1, 7, , 8]);
                            if (!projektArtikelData.artikel.handy) return [3, 4];
                            return [4, this.prisma.handy.findUnique({
                                    where: {
                                        handy_id: projektArtikelData.artikel.handy.handy_id
                                    }
                                })];
                        case 2:
                            existingHandy = _a.sent();
                            if (!existingHandy) return [3, 4];
                            return [4, this.prisma.handy.update({
                                    where: {
                                        handy_id: projektArtikelData.artikel.handy.handy_id
                                    },
